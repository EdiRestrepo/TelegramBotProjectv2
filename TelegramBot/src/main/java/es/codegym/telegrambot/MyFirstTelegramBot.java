...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    public static final String NAME = "CodeGymEdisonBot_bot";
    public static final String TOKEN = "6634772749:AAFRC3Cv2lRWjvSjqHbFsth-x_bHNHK1UoQ";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if(getCallbackQueryButtonKey().equals("step_4_btn")){
            ...
            sendTextMessageAsync(STEP_5_TEXT,
                    Map.of("Ponerse la GoPro y encenderla", "step_5_btn"));
        }
        ...
        if(getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("Comerse un raton +40 de fama", "step_6_btn",
                            "Que muera el perro +40 de fama", "step_6_btn"));
        }
        ...
        if(getCallbackQueryButtonKey().equals("step_6_btn")){
            ...
            sendTextMessageAsync(STEP_7_TEXT,
                    Map.of("Hackear contraseña de la computadora!", "step_7_btn"));
        }
        ...
        if(getCallbackQueryButtonKey().equals("step_7_btn")){
            ...
            sendTextMessageAsync(STEP_8_TEXT,
                    Map.of("Terminar tareas!", "step_8_btn"));
        }
...
/*   if(getMessageText().equals("/start")){
            sendTextMessageAsync("Hola _futuro_ *programador Edison*!");
        }
